...
def factorial(fact_value, answer_lbl):
    try:
        ...
        shake(root)  # Shake the window for invalid entries
...
def gui(root):
    ...
    # loop example
    for i in range(3, 15):
        e_lbl = tk.Label(content, text="loop", bg='black', fg='white')
...
# ee thazhey ulla 3 functions  scrolling feature to entey window 
